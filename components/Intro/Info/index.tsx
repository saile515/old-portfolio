			...
			<div className="m-10 min-h-[60vh] w-[80%] grid grid-rows-[auto_1fr] gap-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-[repeat(6,minmax(10rem,1fr))] md:grid-rows-[repeat(3,minmax(10rem,1fr))] lg:grid-rows-2 gap-4 rounded-xl overflow-hidden">
					<FeatureBox
						...
						img="/Search.svg"
						name="SEO"
						description="Sökmotoroprimering gör att din sida hamnar högst upp i google resultaten, vilket gör att din sida får mer trafik."
					/>
					...
					<FeatureBox index={1} img="/Accessibility.svg" name="Tillgänglighet" description="Jag gör tillgängliga sidor för alla männsikor, oavsett förutsättningar." />
				</div>
			</div>
		</div>
	);
