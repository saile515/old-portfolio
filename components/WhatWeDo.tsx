...
function InfoBox(props: {
	...
	return (
		<button
			...
			className={`px-4 py-2 w-full sm:w-64 text-left text-2xl leading-10 font-title  bg-teal-400 dark:bg-teal-600 rounded-lg sm:hover:translate-x-2 transition-all flex items-center overflow-hidden ${
